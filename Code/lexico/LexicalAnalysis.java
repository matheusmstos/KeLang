...
public class LexicalAnalysis implements AutoCloseable {
	...
	public SymbolTable getTabelaSimbolo() {
		return this.st;
	}
	...
	public Lexeme nextToken() throws IOException {
		...
		while (estado != 11 && estado != 12) { // Estado 12 é estado de erro padrão.
			...
			if (Character.isUpperCase(c)) {
				c = c + 32; // Esse trecho converte o caractere maiúsculo em mínusculo baseado na tabela
							// ASCII.
			}
			// System.out.println("[" + estado + ", \'" + ((char) c) + "\']"); //Esta linha
			// é apenas para caso de teste
		...
		// st.print(); Imprime na tabela de símbolos (Via debug)
		return lex;
	}
}
